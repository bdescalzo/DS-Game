/*---------------------------------------------------------------------------------
Definición del sistema de video, NO SE NECESITA CAMBIAR NADA AQUÍ
---------------------------------------------------------------------------------*/
...
void inicializarVideo() {
    /*  Mapeo de memoria para mostrar imágenes en las dos pantallas */
    ...
    /*  Modo de vídeo de la segunda pantalla */
    videoSetModeSub(MODE_5_2D | // Modo de vídeo 5
...
/*******************************************************************************************/
    ...
    /*  Si se quiere poner el gráfico en otra posición, hay que modificar esto */
    REG_BG3X = 0;
    REG_BG3Y = 0;
/*******************************************************************************************/
...
/*******************************************************************************************/
    /*  Definir el estado del fondo 3 de la pantalla principal */
    /*  Cambiar lo siguiente si el gráfico se quiere establecer en otro lugar */
